...
- Type of buttons you pressend in the queue (Skip, Forgot, Hard, Good, Easy)
...
- No full dark mode support yet.
- No mobile support yet.

## Contributing

Thanks to: 
- @bjsi for making the popup widget scrollable.
- @hugomarins for the huge refactoring, great improvements and many fixes.
